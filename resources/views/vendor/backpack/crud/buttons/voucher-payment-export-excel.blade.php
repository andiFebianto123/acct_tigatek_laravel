<button id="btn-export-excel-voucher-payment" class="btn btn-primary">
...
@push('after_scripts')
    <script>
        ...
        $('#btn-export-excel-voucher-payment').click(async function (){
            setLoadingButton("#btn-export-excel-voucher-payment", true);
            ...
            if(get_url_export == ''){
                setLoadingButton("#btn-export-excel-voucher-payment", false);
                swal({
                    title: "Error",
                    text: "Export URL not defined",
                    icon: "error",
                    timer: 4000,
                    buttons: false,
                });
