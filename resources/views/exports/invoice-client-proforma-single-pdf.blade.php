...
<body>
    @php
        ...
        $ppn_nominal = round($grand_total > $subtotal ? ($grand_total - $subtotal) : (($subtotal * $ppn_percent) / 100), 2);
    ...
    <div class="info-section">
        <div class="client-info">
            ...
            <div class="client-phone">{{ $header->client->phone ?? $header->client_po->client->phone ?? '-' }}</div>
            <div style="width: 80%;">
                {!! nl2br(e($header->client->address ?? $header->client_po->client->address ?? '-')) !!}
            </div>
        </div>
        <div class="po-meta">
            <table>
