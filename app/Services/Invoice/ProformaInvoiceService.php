...
class ProformaInvoiceService
{
    ...
    private function mapDtoToModel(ProformaInvoice $invoice, ProformaInvoiceSaveData $dto, float $total_price, float $diskon_pph): void
    {
        ...
        $invoice->nominal_exclude_ppn_base = round($dto->nominal_exclude_ppn * $exchangeRate, 2);
        $invoice->nominal_include_ppn_base = round($dto->nominal_include_ppn * $exchangeRate, 2);
