...
class DeliveryNoteCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField([
            ...
            'type'  => 'custom_html',
            'value' => '<div class="form-group col-md-12"><label class="font-weight-bold">' . trans('backpack::crud.delivery_note.field.items.header') . '</label><div id="delivery_note_invoice_items_container" class="table-responsive"><table class="table table-bordered table-sm align-middle" id="table-invoice-items" style="table-layout: fixed; width: 100%;"><thead class="table-dark"><tr><th class="text-center" style="width: 40px;">#</th><th style="width: 38%;">' . trans('backpack::crud.delivery_note.field.items.select_stock_placeholder') . '</th><th>' . trans('backpack::crud.delivery_note.field.items.description_placeholder') . '</th><th class="text-center" style="width: 90px;">' . trans('backpack::crud.delivery_note.field.items.qty') . '</th><th class="text-center" style="width: 50px;">' . trans('backpack::crud.delivery_note.field.items.action') . '</th></tr></thead><tbody></tbody></table><div class="mt-2"><button type="button" class="btn btn-sm btn-outline-primary" id="btn-add-dn-item"><i class="la la-plus"></i> ' . trans('backpack::crud.delivery_note.field.items.add_row') . '</button></div></div></div>',
            'wrapper' => ['class' => 'form-group col-md-12'],
        ]);
    }
