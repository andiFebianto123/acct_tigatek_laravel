...
return [
    ...
    */
    ...
    'setting' => [
        ...
        'company_setting' => 'Pengaturan Perusahaan',
        'logo_dark' => 'Logo Dark',
        ...
        'currency' => 'Mata Uang',
        'position_currency_symbol' => 'Posisi Simbol Mata Uang',
        'pre' => 'Pre',
        'post' => 'Post',
        'po_prefix' => 'PO Prefix',
        'work_code_prefix' => 'Kode Kerja Prefix',
        'faktur_prefix' => 'Faktur Prefix',
        'pi_prefix' => 'PI Prefix',
        'quotation_prefix' => 'Quotation Prefix',
        'currency_symbol' => 'Simbol Mata Uang',
        'usd_rate' => 'Kurs USD (USD ke IDR)',
        'format_decimal_number' => 'Format Angka Desimal',
        ...
        'city' => 'Kota/Kabupaten',
        'zip_code' => 'ZIP/Kode Pos',
        'phone' => 'Telepon',
        'start_time' => 'Waktu Mulai Perusahaan',
        'tax_number' => 'Nomor Pajak',
        'address' => 'Alamat',
        'province' => 'Provinsi',
        'country' => 'Negara',
        'company_registration_number' => 'Nomor Registrasi Perusahaan',
        'end_time' => 'Waktu Berakhir Perusahaan',
    ...
    'profit_lost' => [
        ...
        'title_modal_edit_project' => 'Edit Laporan Laba Rugi Proyek',
        ...
        'column' => [
            ...
            'profit_lost_supplier' => 'Laba Kotor',
            'total_qty_sold' => 'Qty Terjual',
            'avg_harga_jual_satuan' => 'Avg Jual Satuan',
            'avg_harga_beli_satuan' => 'Avg Beli Satuan',
            'margin_percent' => 'Margin (%)',
            'delivery_status' => 'Status Pengiriman',
            'voucher_supplier_value' => 'Biaya Lain - Lain',
        ],
        'detail' => [
