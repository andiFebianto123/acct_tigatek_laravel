...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('purchase_orders', function (Blueprint $table) {
            ...
            $table->decimal('total_value_with_tax_base', 18, 4)->nullable()->after('total_value_with_tax')->comment('Nilai ekuivalen Include PPN dalam Rupiah');
        });

        // Update existing purchase_orders records to IDR defaults
        DB::statement("
            UPDATE purchase_orders
            SET currency_code = 'IDR',
                exchange_rate = 1.000000,
                job_value_base = job_value,
                total_value_with_tax_base = total_value_with_tax
