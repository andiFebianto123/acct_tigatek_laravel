...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("UPDATE proforma_invoice_clients SET currency_code = 'IDR', exchange_rate = 1.000000, price_total_exclude_ppn_base = price_total_exclude_ppn, price_total_include_ppn_base = price_total_include_ppn WHERE price_total_exclude_ppn_base IS NULL");
    }
